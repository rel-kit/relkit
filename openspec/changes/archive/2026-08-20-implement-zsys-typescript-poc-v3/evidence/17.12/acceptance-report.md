...
Stack: `zsys-nightly-1787078392190-14ac0016`  
Backend: `s3://zsys-gate15-state-701150241487-20260818154046/zsys-gate15`
...
| Command                                                                                                            | Exit | Result                                                                      |
| ------------------------------------------------------------------------------------------------------------------ | ---: | --------------------------------------------------------------------------- |
| `ZSYS_AWS_INTEGRATION=0 bun run test:deployment`                                                                   |  `0` | 14 passed, 1 release-gated AWS test skipped, 108 assertions                 |
...
| Readiness           | `/_zsys/v1/health/ready` became successful before smoke calls |
...
| -------------------------- | ----------------------------------------- | ------ |
| Job enqueue/worker         | `/__zsys/aws-smoke/job`                   | pass   |
| Event publish/trigger      | `/__zsys/aws-smoke/event`                 | pass   |
| Bucket put/get             | `/__zsys/aws-smoke/bucket`                | pass   |
| Cache set/get              | `/__zsys/aws-smoke/cache`                 | pass   |
| Logs                       | `/__zsys/aws-smoke/logs`                  | pass   |
...
used `managed-by=zsys`, `app=full-app`, and the exact stack. It returned five
