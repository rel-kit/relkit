...
`@zsys/app`, `@zsys/cli`, `@zsys/cloud-aws`, `create-zsys`, `@zsys/engine`,
`@zsys/events`, `@zsys/inspector-api`, `@zsys/providers-local`,
`@zsys/runtime-hono`, and `@zsys/testing`. The two-root artifact bytes were
