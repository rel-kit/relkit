...
external-types directory at `/tmp/zsys-e2e-types-17-9` supplied
...
| Boundary safety                | Network payloads contained the `zsys.inspector` protocol and no forbidden payload values; bundle scan covered 96 browser and 470 server files with zero violations |
