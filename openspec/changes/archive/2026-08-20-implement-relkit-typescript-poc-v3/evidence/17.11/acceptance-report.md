...
| ----------------------------------------------- | ---: | --------------------------------------------- |
| `bun run scripts/pack-and-smoke-create-relkit.ts` |  `0` | `packed-smoke.stdout.txt`; 27 packed packages |

## Getting started flow

The flow used a fresh parent under
`/var/folders/54/3l8wd4hj6c36slgt3rl572sr0000gp/T/relkit-getting-started-5prpLq`
and the exact generated project path
`/var/folders/54/3l8wd4hj6c36slgt3rl572sr0000gp/T/relkit-getting-started-5prpLq/my-app`.
The local registry
...
| create           | `bunx create-relkit@latest my-app`                                   | `0`                                                                                 |
| install          | `bun install`                                                      | `0`                                                                                 |
| dev              | `bun run dev`                                                      | started on documented port `3000`                                                   |
| route            | `curl "http://localhost:3000/hello?name=RelKit"`                     | `0`; `{"message":"Hello, RelKit!"}`                                                   |
| inspector        | `curl "http://localhost:3000/_relkit/v1/graph"`                      | `0`; graph response contained `protocol`, `version`, `graphHash`, and manifest hash |
...
and `AWS_PROFILE=relkit-docs-smoke`. No deployment command or cloud API call was
