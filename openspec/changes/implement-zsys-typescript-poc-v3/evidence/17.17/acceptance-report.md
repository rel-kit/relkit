...
|  25 | `bunx create-zsys@latest my-app` produces a complete project.                                                                                 | `evidence/17.11/acceptance-report.md`; packed smoke output                                                                                                                  | pass   |
...
| `ZSYS_AWS_INTEGRATION=0 bun run test:deployment`              | exit `0`; 14 passed, 1 release-gated test skipped, 108 assertions                    |
