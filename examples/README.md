...
| ------------------------------------------------- | --------------------------------------------------------- | -------------------------------------------------------------------------------- |
| Application, profiles, environment, secrets       | `commerce/relkit.config.ts`, `commerce/src/env.ts`        | `tests/integration/commerce-example-consistency.test.ts`                         |
...
| Services and scoped middleware                    | `commerce/src/services`, `commerce/src/functions/orders`  | `tests/integration/http/service-contract.test.ts`                                |
...
| Native LangChain/LangGraph/DeepAgents workflows   | `commerce/src/orders/agents`, `commerce/src/orders/tools` | `tests/integration/agents/commerce-example.test.ts`                              |
...
| AWS deploy profile                                | `commerce/relkit.config.ts`                               | `tests/deployment/aws-integration.test.ts`                                       |
