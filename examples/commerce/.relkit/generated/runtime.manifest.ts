...
import * as __relkit_module_3 from "../../src/announcements/channels/announcements.channel.ts";
import * as __relkit_module_4 from "../../src/announcements/functions/get-announcements.function.ts";
import * as __relkit_module_5 from "../../src/announcements/functions/post-announcement.function.ts";
import * as __relkit_module_6 from "../../src/announcements/service.ts";
import * as __relkit_module_7 from "../../src/assets/buckets/assets.bucket.ts";
import * as __relkit_module_8 from "../../src/assets/functions/upload-assets.function.ts";
import * as __relkit_module_9 from "../../src/assets/service.ts";
import * as __relkit_module_10 from "../../src/auth/service.ts";
import * as __relkit_module_11 from "../../src/database/service.ts";
import * as __relkit_module_12 from "../../src/navigation/functions/browse-path.function.ts";
import * as __relkit_module_13 from "../../src/navigation/service.ts";
import * as __relkit_module_14 from "../../src/orders/agents/order-deep.agent.ts";
import * as __relkit_module_15 from "../../src/orders/agents/order-review.agent.ts";
import * as __relkit_module_16 from "../../src/orders/agents/order-support.agent.ts";
import * as __relkit_module_17 from "../../src/orders/buckets/agent-workspace.bucket.ts";
import * as __relkit_module_18 from "../../src/orders/cache/prices.cache.ts";
import * as __relkit_module_19 from "../../src/orders/cache/rate-limits.cache.ts";
import * as __relkit_module_20 from "../../src/orders/channels/order-updates.channel.ts";
import * as __relkit_module_21 from "../../src/orders/functions/authorize-order.function.ts";
import * as __relkit_module_22 from "../../src/orders/functions/create-order.function.ts";
import * as __relkit_module_23 from "../../src/orders/functions/delete-order.function.ts";
import * as __relkit_module_24 from "../../src/orders/functions/get-order.function.ts";
...
__relkit_bindDescriptorIdentity(__relkit_module_3["default"], "announcements.feed");
__relkit_bindDescriptorIdentity(__relkit_module_4["default"], "announcements.get-announcements");
__relkit_bindDescriptorIdentity(__relkit_module_5["default"], "announcements.post-announcement");
__relkit_bindDescriptorIdentity(__relkit_module_6["default"], "announcements");
__relkit_bindDescriptorIdentity(__relkit_module_6["default"]["getAnnouncements"], "announcements.get-announcements");
__relkit_bindDescriptorIdentity(__relkit_module_6["default"]["postAnnouncement"], "announcements.post-announcement");
__relkit_bindDescriptorIdentity(__relkit_module_7["default"], "assets.objects");
__relkit_bindDescriptorIdentity(__relkit_module_8["default"], "assets.upload-assets");
__relkit_bindDescriptorIdentity(__relkit_module_8["default"]["dependencies"]["buckets"]["assets"], "assets.objects");
__relkit_bindDescriptorIdentity(__relkit_module_9["default"], "assets");
__relkit_bindDescriptorIdentity(__relkit_module_9["default"]["uploadAssets"], "assets.upload-assets");
__relkit_bindDescriptorIdentity(__relkit_module_9["default"]["uploadAssets"]["dependencies"]["buckets"]["assets"], "assets.objects");
__relkit_bindDescriptorIdentity(__relkit_module_10["default"], "auth");
__relkit_bindDescriptorIdentity(__relkit_module_11["default"], "database");
__relkit_bindDescriptorIdentity(__relkit_module_12["default"], "navigation.browse-path");
__relkit_bindDescriptorIdentity(__relkit_module_13["default"], "navigation");
__relkit_bindDescriptorIdentity(__relkit_module_13["default"]["browsePath"], "navigation.browse-path");
__relkit_bindDescriptorIdentity(__relkit_module_14["default"], "orders.order-deep");
__relkit_bindDescriptorIdentity(__relkit_module_14["default"]["backend"], "orders.agent-workspace");
__relkit_bindDescriptorIdentity(__relkit_module_14["default"]["subagents"][0], "inventory-specialist");
__relkit_bindDescriptorIdentity(__relkit_module_15["default"], "orders.order-review");
__relkit_bindDescriptorIdentity(__relkit_module_16["default"], "orders.order-support");
__relkit_bindDescriptorIdentity(__relkit_module_17["default"], "orders.agent-workspace");
__relkit_bindDescriptorIdentity(__relkit_module_18["default"], "orders.prices");
__relkit_bindDescriptorIdentity(__relkit_module_19["default"], "orders.rate-limits");
__relkit_bindDescriptorIdentity(__relkit_module_20["default"], "orders.updates");
__relkit_bindDescriptorIdentity(__relkit_module_21["default"], "orders.authorize-order");
__relkit_bindDescriptorIdentity(__relkit_module_22["default"], "orders.create-order");
__relkit_bindDescriptorIdentity(__relkit_module_22["default"]["dependencies"]["cache"]["prices"], "orders.prices");
__relkit_bindDescriptorIdentity(__relkit_module_23["default"], "orders.delete-order");
__relkit_bindDescriptorIdentity(__relkit_module_24["default"], "orders.get-order");
__relkit_bindDescriptorIdentity(__relkit_module_24["default"]["errors"][0], "orders.not-found");
