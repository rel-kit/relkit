export const NORMALIZE_CODES = Object.freeze({
  ...
  jobName: "RELKIT_JOB_NAME_INVALID",
  jobTask: "RELKIT_JOB_TASK_INVALID",
  jobBinding: "RELKIT_JOB_BINDING_INVALID",
  ...
  appConfigAlias: "RELKIT_APP_CONFIG_ALIAS",
  appLegacyAlias: "RELKIT_APP_LEGACY_JOB_ALIAS",
  jobProfile: "RELKIT_JOB_PROFILE_DEPRECATED",
  jobCapability: "RELKIT_JOB_CAPABILITY_UNSUPPORTED",
  jobProjection: "RELKIT_JOB_SCHEMA_PROJECTION_UNSAFE",
  jobExposure: "RELKIT_JOB_OPERATION_EXPOSURE_INVALID",
  jobResources: "RELKIT_JOB_RESOURCES_UNSUPPORTED",
  jobSchedule: "RELKIT_JOB_SCHEDULE_INVALID",
  jobVersion: "RELKIT_JOB_VERSION_INCOMPATIBLE",
  jobReplay: "RELKIT_JOB_REPLAY_ADVISORY",
  jobManifest: "RELKIT_JOBS_MANIFEST_INVALID",
  legacyJobs: "RELKIT_LEGACY_JOBS_DISABLED",
  graphIdCollision: "RELKIT_GRAPH_ID_COLLISION",
} as const);
