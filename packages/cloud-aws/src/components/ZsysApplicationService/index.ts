...
import type { ZsysApplicationServiceArgs } from "./types.js";
import { containerDefinitions } from "./container.js";
import { createFoundation } from "./foundation.js";

export type { ZsysApplicationServiceArgs } from "./types.js";
/** ECS/Fargate application behind an internet-facing ALB with safe deployment defaults. */
export class ZsysApplicationService extends pulumi.ComponentResource {
  ...
  constructor(
    name: string,
    args: ZsysApplicationServiceArgs,
    opts: pulumi.ComponentResourceOptions = {},
  ) {
    const componentName = resourceName(name, "service", args);
    super("zsys:cloud-aws:ZsysApplicationService", componentName, {}, opts);
