...
export interface RelkitValkeyClientOptions {
  readonly url: string;
...
export interface RelkitValkeyClient {
...
export function createValkeyClient(options: RelkitValkeyClientOptions): RelkitValkeyClient {
