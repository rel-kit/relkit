...
import type { RelkitObservabilityArgs, RelkitObservabilityResources } from "./types.js";

export * from "./types.js";

/** Maps runtime logs to CloudWatch and optional traces to OTLP injection. */
export class RelkitObservability
  extends pulumi.ComponentResource
  implements RelkitObservabilityResources
{
  ...
  readonly environment: RelkitObservabilityResources["environment"];
  readonly secrets: RelkitObservabilityResources["secrets"];
  readonly tags: pulumi.Output<Record<string, string>>;

  constructor(
    name: string,
    args: RelkitObservabilityArgs = {},
    opts: pulumi.ComponentResourceOptions = {},
  ) {
    const componentName = resourceName(name, "observability", args, 64);
    super("relkit:cloud-aws:RelkitObservability", componentName, {}, opts);
