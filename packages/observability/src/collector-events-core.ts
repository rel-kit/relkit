...
import { collectorValuesCore } from "./collector-values-core.js";
import { collectorRecordsCore } from "./collector-records-core.js";
import type { RecordLike } from "./collector-values.types.js";
const { isInvocation, isModelRecord, isRecord, isRuntimeLog, text } = collectorValuesCore;
const { invocationRecord, logRecord, spanRecord } = collectorRecordsCore;
function toObservabilityRecord(value: unknown): ObservabilityRecord | undefined {
...
/** Internal event conversion rule executed by the observed Effect operation. */
export const collectorEventsCore = { toObservabilityRecord };
