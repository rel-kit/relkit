...
import type { OBSERVABILITY_INDEX_VERSION } from "./index-types.js";

/** Serialized index snapshot persisted beside segment files. */
...
/** Retention limits enforced by the local segment index. */
...
/** Index storage, clock, redaction, and page settings. */
...
/** Physical segment location and indexed record fields. */
...
/** Filters and cursor limits for an index page. */
...
/** One cursor page of index entries. */
export interface ObservabilityIndexPage {
  readonly entries: readonly ObservabilityIndexEntry[];
  readonly nextCursor?: string;
}

/** Current index size and segment count. */
...
/** Number of records and bytes removed by a retention pass. */
...
/** Live index over bounded local segment files. */
