...
import type { StoredIndex } from "./index.types.js";
...
import {
  ...
  stats,
  trimEntries,
} from "./index-memory-core.js";
import { indexRetentionCore } from "./index-retention-core.js";
import { indexTracesCore } from "./index-traces-core.js";
import { createIndexState, normalizeOptions, safeSegmentPath } from "./index-state-core.js";
...
const { ensureDirectory, ensureSegmentRoot, repairSegments, writeAtomic } = segmentFilesCore;
const { scanObservabilitySegments } = indexFilesCore;
const { enforceRetention } = indexRetentionCore;
const { readTracePage } = indexTracesCore;
async function createObservabilityIndex(
...
async function readRecord(
  ...
  try {
    ...
    const value = recordAdmissionCore.admitRedacted(
      redactionCore.redactRecord(
...
export const indexCore = { createObservabilityIndex };
