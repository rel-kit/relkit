...
import { INVOCATION_OUTCOMES, collectorValuesCore } from "./collector-values-core.js";
import type { RecordLike } from "./collector-values.types.js";
const { isRecord, text } = collectorValuesCore;
function invocationRecord(value: RecordLike): InvocationRecord | undefined {
...
function spanRecord(value: RecordLike): SpanRecord | undefined {
...
function logRecord(value: RecordLike): LogRecord | undefined {
...
/** Internal pure conversion rules executed by observed Effect operations. */
export const collectorRecordsCore = { invocationRecord, spanRecord, logRecord };
