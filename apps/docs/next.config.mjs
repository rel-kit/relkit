...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      ["/docs/fundamentals/providers", "/docs/integrations"],
      ["/docs/fundamentals/services", "/docs/service/define"],
      ["/docs/fundamentals/domain-first-migration", "/docs/service/organization"],
      ["/docs/async/events", "/docs/events"],
      ["/docs/async/listeners", "/docs/events/consume"],
      ["/docs/async/jobs", "/docs/jobs"],
      ["/docs/async/schedules", "/docs/jobs/schedules"],
      ["/docs/jobs/define", "/docs/jobs/quickstart"],
      ["/docs/jobs/enqueue", "/docs/jobs/quickstart"],
      ["/docs/jobs/first-job", "/docs/jobs/quickstart"],
      ["/docs/jobs/retries", "/docs/jobs/retries-and-idempotency"],
      ["/docs/jobs/idempotency", "/docs/jobs/retries-and-idempotency"],
