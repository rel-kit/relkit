...
const OWNERS = {
  ...
  "@relkit/effect-mq": "integrations/packages/effect-mq/package.json",
  "@relkit/inngest": "integrations/packages/inngest/package.json",
  ...
  "@relkit/trigger": "integrations/packages/trigger/package.json",
