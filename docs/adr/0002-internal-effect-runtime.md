# RELKIT-ADR-002: Internal Effect runtime
...
RelKit needs managed scopes, cancellation, deadlines, structured failures,
...
- `docs/relkit-typescript-poc-technical-spec-v3.md` §§2.3, 6.3–6.5, 8, 13.
- `docs/relkit-typescript-poc-review-gates-v3.md` Gates 0, 1, 4, 5, and 16.
- `openspec/changes/implement-relkit-typescript-poc-v3/specs/public-authoring/spec.md` — Plain TypeScript public boundary.
- `openspec/changes/implement-relkit-typescript-poc-v3/specs/function-runtime/spec.md` — Internal Effect execution and context-preserving invocation.
