# ZSYS-ADR-005: Pulumi-only deployment
...
ZSys needs deployment plans that remain independent of cloud SDK and
...
2. Build a ZSys-owned infrastructure state and provisioning engine.
...
deployment engine and state authority. ZSys will not add an alternate IaC
...
- `docs/zsys-typescript-poc-technical-spec-v3.md` §§2.4, 6.3, 12, 22.
- `docs/zsys-typescript-poc-review-gates-v3.md` Gates 0, 15, and 16.
- `openspec/changes/implement-zsys-typescript-poc-v3/specs/workspace-foundation/spec.md` — Explicit POC scope guardrails.
- `openspec/changes/implement-zsys-typescript-poc-v3/specs/pulumi-aws-deployment/spec.md` — Provider-neutral plan and Pulumi-only deployment engine.
