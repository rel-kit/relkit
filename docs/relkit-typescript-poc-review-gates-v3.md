# RelKit TypeScript POC — Implementation Review Gates

**Revision:** 3
**Companion to:** `relkit-typescript-poc-technical-spec-v3.md`
...
- public examples use `@relkit/schema`, not Effect Schema.
...
relkit deploy preview --stack <isolated-stack> --non-interactive
```
...
packed create-relkit smoke output
